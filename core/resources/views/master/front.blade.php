...
">
                            ...
                            <div class="toolbar d-flex">
                                ...
                                <div class="toolbar-item"><a href="{{route('front.cart')}}">
                                        <div><span class="cart-icon"><i class="icon-shopping-cart"></i><span
                                                ...
                                                </span></span><span class="text-label">{{ __('Cart') }}</span></div>
                                    </a>
                                            ...
                                            <ul>
                                                <li class="{{ request()->routeIs('front.index') ? 'active' : '' }}"><a
                                                        href="{{route('front.index')}}"><i
                                                            class="icon-chevron-right"></i>{{__('Home')}}</a></li>
                                                ...
                                                @if ($setting->is_brands == 1)
                                                    <li class="{{ request()->routeIs('front.brand') ? 'active' : '' }}"><a
                                                            href="{{route('front.brand')}}"><i
                                                                class="icon-chevron-right"></i>{{__('Brand')}}</a></li>
                                                @endif

                                                @if ($setting->is_blog == 1)
                                                    <li class="{{ request()->routeIs('front.blog*') ? 'active' : '' }}"><a
                                                            href="{{route('front.blog')}}"><i
                                                                class="icon-chevron-right"></i>{{__('Blog')}}</a></li>
                                                @endif
                                                ...
                                                @if ($setting->is_contact == 1)
                                                    <li class="{{ request()->routeIs('front.contact') ? 'active' : '' }}"><a
                                                            href="{{route('front.contact')}}"><i
                                                                class="icon-chevron-right"></i>{{__('Contact')}}</a></li>
                                                @endif
                                            </ul>
                                        </nav>
                                    </div>
                        ...
                        <div class="nav-inner">
                            <nav class="site-menu">
                                <ul>
                                    ...
                                    @endif
                                    @if ($setting->is_campaign == 1)
                                        <li class="{{ request()->routeIs('front.campaign') ? 'active' : '' }}"><a
                                                href="{{route('front.campaign')}}">{{__('Campaign')}}</a></li>
                                    @endif
                                    @if ($setting->is_brands == 1)
                                        <li class="{{ request()->routeIs('front.brand') ? 'active' : '' }}"><a
                                                href="{{route('front.brand')}}">{{__('Brand')}}</a></li>
                                    @endif
                                    @if ($setting->is_blog == 1)
                                        <li class="{{ request()->routeIs('front.blog*') ? 'active' : '' }}"><a
    ...
    <style>
        ...
        .white-image {
            filter: brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(7500%) hue-rotate(336deg) brightness(105%) contrast(103%);
        }
    </style>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <!-- Contact Info-->
                    <section class="widget widget-light-skin text-white">
                        <h3 class="widget-title text-white">{{__('Get In Touch')}}</h3>

                        <div class="site-branding">
                            <a class="site-logo align-self-center" href="{{route('front.index')}}">
                                <img width="120px" class="white-image"
                                    src="{{asset('assets/images/' . $setting->logo)}}" alt="{{$setting->title}}">
                            </a>
                        </div>
                        ...
                        {{-- <ul class="list-unstyled text-sm">
                            ...
                            <li><span class=""><strong>{{__('Saturday')}}: </strong></span>{{$setting->satureday_start}}
                                - {{$setting->satureday_end}}</li>
                        </ul> --}}
                        @php
                ...
                {{-- <div class="col-lg-4 col-sm-6">
                    <!-- Customer Info-->
                    <div class="widget widget-links widget-light-skin ">
                        <h3 class="widget-title text-white">{{__('Usefull Links')}}</h3>
                        <ul>
                            @if ($setting->is_faq == 1)
                            <li>
                                <a class="text-white" href="{{route('front.faq')}}">{{__('Faq')}}</a>
                            </li>
                            @endif
                            @foreach (DB::table('pages')->wherePos(2)->orwhere('pos', 1)->get() as $page)
                            <li><a class="text-white" href="{{route('front.page', $page->slug)}}">{{$page->title}}</a>
                            </li>
                            @endforeach
                ...
                <div class="col-lg-4">
                    ...
                    <section class="widget">
                        <h3 class="widget-title text-white">{{__('Pages')}}</h3>
                        <ul>
                            @foreach (DB::table('pages')->wherePos(2)->orwhere('pos', 1)->get() as $page)
                                <li>
                                    <a class="text-white" href="{{route('front.page', $page->slug)}}">{{$page->title}}</a>
                                </li>
                            @endforeach
                        </ul>
                        {{-- <form class="row subscriber-form" action="{{route('front.subscriber.submit')}}"
                            ...
                            <div class="col-lg-12">
                                <p class="text-sm opacity-80 pt-2 text-white">
                                    {{__('Subscribe to our Newsletter to receive early discount offers, latest news,
                                    sales and promo information.')}}
                                </p>
                            </div>
                        </form> --}}
            ...
            <!-- Copyright-->
            <p class="footer-copyright text-white"> {{$setting->copy_right}}</p>
        </div>
    </footer>
    ...
    <script type="text/javascript"
        src="{{asset('assets/back/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
