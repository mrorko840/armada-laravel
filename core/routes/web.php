...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group([], function () {
            ...
            Route::put('/setting/update', 'Back\SettingController@update')->name('back.setting.update'); // problem in this route
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/category/{category}', 'Front\CatalogController@subCategory')->name('front.category.view');
